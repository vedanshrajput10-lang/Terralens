const TRANSLATIONS = {
  hinglish: {
    ...
    health: "Health",
    risk: "Risk",
    nayaKhetJodein: "Naya khet jodein",
    loading: "Loading...",
    khetNahiMila: "Koi field nahi mila. Naya khet jodein!",

    nayaKhetHeading: "Naya Khet Jodein",
    khetPhoto: "Khet ki Photo",
    ...
    hindiEnglishSub: "Hindi + English mein",
    hindi: "हिंदी",
    hindiSub: "सरल हिंदी में",
    english: "English",
  ...
  hindi: {
    ...
    health: "स्वास्थ्य",
    risk: "जोखिम",
    nayaKhetJodein: "नया खेत जोड़ें",
    loading: "लोड हो रहा है...",
    khetNahiMila: "कोई खेत नहीं मिला। नया खेत जोड़ें!",

    nayaKhetHeading: "नया खेत जोड़ें",
    khetPhoto: "खेत की फोटो",
    ...
    hindiEnglishSub: "हिंदी + अंग्रेज़ी में",
    hindi: "हिंदी",
    hindiSub: "सरल हिंदी में",
    english: "अंग्रेज़ी",
    englishSub: "सरल अंग्रेज़ी",
  ...
  english: {
    ...
    health: "Health",
    risk: "Risk",
    nayaKhetJodein: "Add New Field",
    loading: "Loading...",
    khetNahiMila: "No fields found. Add a new field!",

    nayaKhetHeading: "Add New Field",
    khetPhoto: "Field Photo",
    fieldName: "Field Name",
    village: "Village",
    district: "District",
    latitude: "Latitude",
